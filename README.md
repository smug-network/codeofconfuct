...
* Direct messages or postings in channels/private groups of an overly sales/advertising/spam manner ([additional vendor guidelines](https://github.com/smug-network/codeofconduct/blob/master/Vendor_Guidelines.md))
